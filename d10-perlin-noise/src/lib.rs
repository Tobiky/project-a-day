...
pub fn blerp(tl: f32, tr: f32, bl: f32, br: f32, x_weight: f32, y_weight: f32) -> f32 {
...
pub fn random_gradient(#[allow(unused_variables)] grid_point @ [x, y]: [i32; 2]) -> [f32; 2] {
